    ...
    <section className="py-16 bg-gray-100">
      <div className="container mx-auto ">
        <div className="text-center mb-12 ">
          <h2 className="text-4xl font-bold mb-4 hover-section">Our Hearing Solutions</h2>
          <p className="text-lg text-gray-600 hover-section">Explore the range of products and services we offer to improve your hearing.</p>
        </div>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="bg-white shadow-lg rounded-lg p-6 hover-section animate-fadeIn">
